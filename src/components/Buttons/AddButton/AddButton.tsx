...
export default function AddButton({
  ...
  const varients = {
    light:
      "border-teal-600 text-teal-600 hover:bg-teal-700 hover:text-gray-200",
    dark: "bg-teal-700 text-gray-200 border-teal-700 hover:bg-gray-50 hover:text-teal-700",
  };
  ...
  return (
    <>
    {tooltipMessage ?<Tooltip title={tooltipMessage}>
      <button
