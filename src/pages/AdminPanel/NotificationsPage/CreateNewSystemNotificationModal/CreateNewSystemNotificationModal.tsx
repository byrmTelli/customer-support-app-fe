...
import { createNewSystemNotificationDefaults, CreateNewSystemNotificationFormModel, CreateNewSystemNotificationModalProps, createNewsystemNotificationSchema } from "./types";
...
export default function CreateNewSystemNotificationModal({isOpen,onClose}:CreateNewSystemNotificationModalProps){
    // States
    const currentUser = useAppSelector(state => state.user);
    // Queries
    const [createNewSystemNotificaiton] = apiNotification.usePostApiNotificationCreateSystemNotificationMutation();
    // Mutations
    // Form
    ...
    return <Modal isOpen ={isOpen} onClose={onClose}>
        ...
        <Modal.Content>
            ...
            <form 
                ...
                onSubmit={form.handleSubmit(handleCreateNewSystemNotificationButtonClick)}
            >
            ...
            <div className="flex flex-col gap-2">
              <h1 className="font-semibold pl-2">Message</h1>
              <div className=" p-2 flex flex-col gap-2 focus-within:border-teal-700">
              <Controller
                  name="message"
                  control={form.control}
            ...
            <div className="w-full flex">
                  <Button onClick={form.handleSubmit(handleCreateNewSystemNotificationButtonClick)} title={"Submit"} className="flex w-full" varient="success"/>
            </div>
            </form>
            </div>
        </Modal.Content>
